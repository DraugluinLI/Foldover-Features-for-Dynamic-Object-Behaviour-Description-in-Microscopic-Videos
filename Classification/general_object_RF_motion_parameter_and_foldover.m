%%  General image RF classification (based on VGG16's xyz three directional features) can choose whether to fuse the foldover feature and motion parameters合
